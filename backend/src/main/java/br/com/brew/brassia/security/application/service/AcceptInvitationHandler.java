...
/**
 * Aceite de convite: valida o token, verifica o e-mail e ativa a conta
 * (INVITED → ACTIVE), consumindo o token (uso único). Mensagens de erro são
 * genéricas para não permitir enumeração de tokens/contas.
 */

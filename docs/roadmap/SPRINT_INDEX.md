...
- Sprint 19 — [Operação comercial e CRM](../../sprints/sprint-19-commercial-operations/README.md): Ligar produção, pedidos, clientes, preços e previsão de demanda. **Concluída em 2026-08-15** — 6/6 histórias, mais a SAL-001-B nascida de uma dúvida respondida no caminho. FCST-001 entrega demanda e **não** capacidade (DUV-FCST-001). Construída sob premissa declarada: desenvolver não exige produção, publicar exige. Ver DEC-SPR-019.
...
- Sprint 21 — [Conectores externos](../../sprints/sprint-21-external-connectors/README.md): **suspensa** por decisão do mantenedor (DEC-INT-002). Conector de conta com serviço de terceiro está fora do escopo; importação de receita de fora, se voltar a ser pedida, é por arquivo BeerJSON/BeerXML.

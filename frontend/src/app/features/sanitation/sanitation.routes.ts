...
import { CycleDetailPageComponent } from './pages/cycle-detail-page/cycle-detail-page.component';
import { CyclesPageComponent } from './pages/cycles-page/cycles-page.component';
...
export const SANITATION_CYCLE_ROUTES: Routes = [
  { path: '', component: CyclesPageComponent },
  { path: ':id', component: CycleDetailPageComponent },
];

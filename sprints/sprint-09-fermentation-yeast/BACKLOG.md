...
**Objetivo:** Planejar e acompanhar rampas, descanso, dry hop, cold crash, transferência e acondicionamento.

**Critérios específicos:**

- Cada etapa possui condição, janela, ação, tolerância e responsável.
- Alterar uma data recalcula somente dependências confirmadas e apresenta prévia.
- Alerta não altera setpoint nem equipamento automaticamente.
- Planejado, executado, desvio e justificativa permanecem no histórico.
